...
createLogo('13_LightOrange')
createLogo('14_LightYellow')
createLogo('15_LightGreen')
createLogo('16_FrostFlame')
createLogo('17_LightPink')
createLogo('18_ShadowDragon')
createLogo('19_Death')
createLogo('20_Death')
createLogo('21_PinkAngel')
createLogo('22_PrimalDragon')
createLogo('23_White')