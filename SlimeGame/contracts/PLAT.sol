...
contract PLATToken is IPLAT, ERC20, Ownable {
  ...
  /**
   * mints $PLAT to a recipient
   * @param to the recipient of the $PLAT
   * @param amount the amount of $PLAT to mint
   */
  ...
  /**
   * burns $PLAT from a holder
   * @param from the holder of the $PLAT
   * @param amount the amount of $PLAT to burn
   */
  ...
  function transferFrom(
      ...
      address recipient,
      uint256 amount
  ) public virtual override(ERC20, IPLAT) disallowIfStateIsChanging returns (bool) {
